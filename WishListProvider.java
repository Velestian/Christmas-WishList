...
public class WishListProvider extends ContentProvider{
    ...
    public static final String AUTHORITY = "com.gretchen.christmaswishlist.provider";
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch(match){
            case MATCH_INT:{
                long id = new WishListDB(getContext()).genericInsert(values);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch(match){
        case MATCH_INT:
            int n = new WishListDB(getContext()).genericUpdate(
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch(match){
        case MATCH_INT:
            int n = new WishListDB(getContext()).genericDelete(selection, selectionArgs);
            getContext().getContentResolver().notifyChange(uri, null);
            return n;
        default:
    ...
    public String getType(Uri uri) {
        ...
        switch(match) {
        case MATCH_INT:
            return "vnd.android.cursor.dir/vnd.com.gretchen.christmaswishlist.provider";
        default:
            throw new UnsupportedOperationException ("URI " + uri + " is not supported.");
        }
    }
